...
if (isset($_POST['tambah_event_baru'])) {
    ...
    foreach ($listPertanyaan as $i => $pertanyaan) {
        ...
        insertDataForm($conn, $idEvent, $pertanyaan, $tipePertanyaan[$i], $dropdownValue, $statusPertanyaan);
    }
