...
<body class="admin-page">
                        ...
                        <div class="ev-footer">
                            ...
                            <?php if ($tab_raw === 'Pending'): ?>
                                <form method="POST" action="<?= BASEURL ?>/app/controllers/admin/aksi-validasi.php"
                                    ...
                                    <input type="hidden" name="redirect"
                                        value="<?= BASEURL ?>/app/controllers/admin/validasi.php?tab=Pending">
                            ...
                            <?php elseif ($tab_raw === 'Dipublikasikan'): ?>
                                ...
                                <form method="POST" action="<?= BASEURL ?>/app/controllers/admin/aksi-validasi.php"
                                    ...
                                    <input type="hidden" name="redirect"
                                        value="<?= BASEURL ?>/app/controllers/admin/validasi.php?tab=Dipublikasikan">
                            ...
                            <?php elseif ($tab_raw === 'Ditolak'): ?>
                                ...
                                <form method="POST" action="<?= BASEURL ?>/app/controllers/admin/aksi-validasi.php"
                                    ...
                                    <input type="hidden" name="aksi" value="pending">
                                    <input type="hidden" name="redirect"
                                        value="<?= BASEURL ?>/app/controllers/admin/validasi.php?tab=Ditolak">
    ...
    <form method="POST" action="<?= BASEURL ?>/app/controllers/admin/aksi-validasi.php" id="formAksi">
        ...
        <input type="hidden" name="redirect" value="<?= BASEURL ?>/app/controllers/admin/validasi.php?tab=<?= $tab_raw ?>">
    </form>
    ...
    <script>
        ...
        function submitReject() {
            ...
            if (!ev) return;
            openRejectModal(currentId, ev.judul);
        }
